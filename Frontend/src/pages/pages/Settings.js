...
const PublicInfo = () => {
  ...
  const handleSaveEvent = async() =>{
    ...
    showSuccessNotification("Change information!","Change avatar successfully!");
  };
          ...
          <Row>
            ...
            <Col md="4">
              <div className="text-center">
                <img
                  src={previewAvatarUrl ? previewAvatarUrl : (userInfo.avatarUrl ? `http://127.0.0.1:8887/ReactJs/Backend/Avatar/${userInfo.avatarUrl}` : defaultAvatar)}
