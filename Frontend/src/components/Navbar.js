...
import defaultAvatar from "../assets/img/avatars/default-avatar.png";
        ...
        <Nav className="ml-auto" navbar>
          ...
          <UncontrolledDropdown nav inNavbar>
            ...
            <span className="d-none d-sm-inline-block">
              <DropdownToggle nav caret>
                <img
                  src={userInfo.avatarUrl?`http://127.0.0.1:8887/ReactJs/Backend/Avatar/${userInfo.avatarUrl}`:defaultAvatar}
            ...
            <DropdownMenu right>
              ...
              <DropdownItem onClick={() => props.history.push("/settings")}>Settings & Privacy</DropdownItem>
              <DropdownItem>Help</DropdownItem>
              <DropdownItem onClick={clearStorage}>Sign out</DropdownItem>
            </DropdownMenu>
          </UncontrolledDropdown>
        </Nav>
      </Collapse>
...
export default withRouter(connect(mapGlobalStateToProps,{toggleSidebar})(NavbarComponent));